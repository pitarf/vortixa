...
async function main() {
  ...
  const models = [
    ...
    },
    {
      ...
      technicalName: 'fal-ai/bytedance/seedance-2.5',
      creditCost: 25,
      apiUnitCost: 0.28,
      toolSlug: 'seedance-2-5',
      toolName: 'ByteDance Seedance 2.5 (Cinema Master)',
    ...
    },
    {
      ...
      creditCost: 20,
      apiUnitCost: 0.22,
      toolSlug: 'kling-3-pro',
      toolName: 'Kling 3.0 Pro Ultra',
      toolDesc: 'Qualidade fotográfica máxima, iluminação de cinema e controle dinâmico temporal avançado.',
    },
    {
      name: 'ByteDance OmniHuman (Avatar Studio)',
      technicalName: 'fal-ai/bytedance/omnihuman',
      creditCost: 25,
      apiUnitCost: 0.28,
      toolSlug: 'omnihuman',
      toolName: 'ByteDance OmniHuman Avatar',

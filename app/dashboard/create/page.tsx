...
const TOOLS: Record<StudioTool, ToolDefinition> = {
  ...
  video: {
    ...
    models: [
      { id: "fal-ai/bytedance/seedance-2.0", name: "ByteDance Seedance 2.0", badge: "Áudio & Física 👑", cost: 25, description: "Motor líder da ByteDance com física real e áudio sincronizado nativo", speed: "~ 45s" },

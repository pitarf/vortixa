...
```mermaid
graph LR
    P1["PASSO 1: CONCEITO & IMAGEM<br/>Digite a cena ou envie uma foto base no motor FLUX.1"] --> P2["PASSO 2: MOVIMENTO & CÂMERA<br/>Escolha o tipo de cena, ângulo e adicione locução"]
    P2 --> P3["PASSO 3: RENDER & MASTER 4K<br/>Exporte seu vídeo ultra-realista pronto para lucrar"]
```

...
export const VIDEO_MODELS: VideoModelDef[] = [
  ...
  {
    id: "fal-ai/bytedance/seedance-2.5",
    name: "ByteDance Seedance 2.5",
    badge: "Cinema Master 👑",
    cost: 25,
    description: "Topo de linha mundial: até 30s de vídeo contínuo, som nativo e física hiper-realista.",
    speed: "~ 55s",
    hasNativeAudio: true,
  ...
  },
  {
    ...
    badge: "Cinema Rápido 🎬",
    cost: 15,
    description: "Versão equilibrada do Kling 3.0: fluidez cinematográfica e excelente fidelidade com menor consumo.",
    speed: "~ 45s",
  ...
  },
  {
    ...
    badge: "Cinema Ultra 👑",
    cost: 20,
    description: "Renderização cinematográfica máxima em alta fidelidade e consistência temporal extrema.",
    speed: "~ 60s",
    thumb: "/media/landing/gallery/perfume_commercial.jpg",
  },
  {

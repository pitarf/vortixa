      ...
      <div className="w-full max-w-md bg-[#0D0E12] border border-rose-500/40 rounded-3xl p-6 sm:p-8 space-y-6 shadow-2xl shadow-rose-950/40 relative overflow-hidden">
        ...
        <div className="text-center space-y-2.5">
          ...
          <p className="text-xs text-slate-300 leading-relaxed">
            Esta seção contém motores de inteligência artificial generativa sem censura moral (NSFW), incluindo nudez artística, lingerie e conteúdo adulto com processamento exclusivo nos <b>Servidores Neurais VORTIXIA</b>.
          </p>
        </div>

...
export function CookieConsentBanner() {
  ...
  return (
    <div className="fixed bottom-4 left-4 right-4 sm:left-6 sm:right-auto sm:max-w-md z-50 animate-in fade-in slide-in-from-bottom-5 duration-300">
      <div className="rounded-2xl border border-slate-200 dark:border-[#1E202E] bg-white/95 dark:bg-[#0D0E12]/95 backdrop-blur-xl p-5 shadow-2xl shadow-black/10 dark:shadow-black/80 text-slate-700 dark:text-slate-200">
        <div className="flex items-start gap-3.5">
          <div className="h-9 w-9 rounded-xl bg-violet-600/10 dark:bg-violet-600/20 border border-violet-500/20 dark:border-violet-500/30 flex items-center justify-center flex-shrink-0 text-violet-600 dark:text-violet-400">
          ...
          <div className="space-y-1.5 flex-1">
            <div className="flex items-center justify-between">
              <h4 className="text-sm font-bold text-slate-900 dark:text-white flex items-center gap-1.5">
                ...
                <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-cyan-500/10 text-cyan-600 dark:text-cyan-400 border border-cyan-500/30">LGPD</span>
              </h4>
              <button
            ...
            <div className="pt-1 text-[11px]">
              <Link
                href="/termos"
                className="text-violet-600 dark:text-violet-400 hover:text-violet-700 dark:hover:text-violet-300 underline font-medium"
              >
        ...
        <div className="mt-4 flex items-center justify-end gap-2.5 pt-3 border-t border-slate-200 dark:border-[#1E202E]">
          <button
            type="button"
            onClick={handleAcceptEssential}
            className="px-3.5 py-2 rounded-xl text-xs font-semibold bg-slate-100 dark:bg-[#13141B] border border-slate-200 dark:border-[#1E202E] hover:bg-slate-200 dark:hover:bg-[#1E202E] text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-all cursor-pointer"

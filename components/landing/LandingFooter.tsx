          ...
          <div className="md:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 text-xs font-sans">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-slate-400">
                ...
                <li>
                  <Link href="/dashboard/tools/motion" className="hover:text-white transition-colors py-1 inline-block min-h-[36px] flex items-center">
                    Motion Control (Kling v3)
                  </Link>
                </li>
                <li>
                  <Link href="/dashboard/tools/lipsync" className="hover:text-white transition-colors py-1 inline-block min-h-[36px] flex items-center">
                    Dublagem & LipSync PT-BR
                  </Link>
                </li>
                <li>
                  <Link href="/dashboard/tools/image" className="hover:text-white transition-colors py-1 inline-block min-h-[36px] flex items-center">
                    FLUX 1.1 Pro Ultra
                  </Link>
                </li>
                <li>
                  <Link href="/dashboard/tools/upscale" className="hover:text-white transition-colors py-1 inline-block min-h-[36px] flex items-center">
                    Creative Upscale 4K
                  </Link>
                </li>
              </ul>
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-slate-400">
                <li>
                  <a href="#gallery" className="hover:text-white transition-colors py-1 inline-block min-h-[36px] flex items-center">
                    Galeria Criativa
                  </a>
                </li>
                <li>
                  <a href="#features" className="hover:text-white transition-colors py-1 inline-block min-h-[36px] flex items-center">
                    Workflows Prontos
                  </a>
                </li>
                <li>
                  <a href="#pricing" className="hover:text-white transition-colors py-1 inline-block min-h-[36px] flex items-center">
                    Comparativo de Economia
                  </a>
                </li>
                <li>
                  <Link href="/dashboard/credits" className="hover:text-white transition-colors py-1 inline-block min-h-[36px] flex items-center">
                    Calculadora de Créditos
                  </Link>
                </li>
                <li>
                  <a href="#faq" className="hover:text-white transition-colors py-1 inline-block min-h-[36px] flex items-center">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-2 text-slate-400">
                ...
                <li>
                  <Link href="/login" className="hover:text-white transition-colors py-1 inline-block min-h-[36px] flex items-center">
                    Área do Assinante
                  </Link>
                </li>
                <li>
                  <a
                    ...
                    className="hover:text-emerald-400 transition-colors py-1 inline-block min-h-[36px] flex items-center"
                  >

...
export function SalesGalleryV2() {
  ...
  const gallery = [
    ...
    },
    {
      ...
      category: "commercial",
      type: "video",
      title: "Comercial de Perfume em Alta Resolução",
      tag: "Produto & Comercial",
      url: "/media/landing/videos/commercial_perfume.mp4",
      poster: "/media/landing/gallery/perfume_commercial.jpg",
      desc: "Anúncio elegante com iluminação de estúdio e gotas em câmera lenta.",
    },
    {
      id: 4,
      category: "fashion",
      type: "image",
      title: "Modelo Brasileira em Estúdio",
      tag: "Fotografia 8K",
      url: "/uploads/fc5afea8-272c-4afc-8deb-beebfa65a118.jpg",
      poster: "/uploads/fc5afea8-272c-4afc-8deb-beebfa65a118.jpg",
      desc: "Retrato nítido com textura autêntica de pele, microporos e iluminação natural.",
    },
    {
      id: 5,
      category: "fashion",
    ...
    },
    {
      ...
      category: "commercial",
      type: "image",
      title: "Retrato Corporativo de Apresentadora",
      tag: "Influencer Institucional",
      url: "/media/landing/gallery/avatar_presenter.jpg",
      poster: "/media/landing/gallery/avatar_presenter.jpg",
      desc: "Personagem para apresentações empresariais, pitches e vídeos explicativos.",
    },
    {
      id: 7,
      category: "ugc",

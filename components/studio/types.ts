...
export const TOOLS: Record<StudioTool, ToolDefinition> = {
  ...
  video: {
    ...
    models: [
      { id: "fal-ai/kling-video/v2.6/pro/image-to-video", name: "Kling 2.6 Pro (Vídeo & Fala Nativa)", badge: "Áudio & Fala 🗣️", cost: 18, description: "Gera vídeo cinematográfico com áudio, fala e atuação sincronizados nativamente em 1 única chamada", speed: "~ 35s" },

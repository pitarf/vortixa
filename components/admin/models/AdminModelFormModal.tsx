...
export function AdminModelFormModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-6 bg-black/85 backdrop-blur-md overscroll-contain animate-in fade-in duration-200">
      <div className="relative w-full sm:max-w-4xl bg-neutral-900 border-0 sm:border border-neutral-800 rounded-none sm:rounded-2xl shadow-2xl overflow-hidden h-full sm:h-auto max-h-screen sm:max-h-[92vh] flex flex-col overscroll-contain">
        {/* Header */}
